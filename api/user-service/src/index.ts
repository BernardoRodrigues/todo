...
import * as httpCreateServer from 'http';
import * as httpsCreateServer from 'https'
import userRouter from './routes/user-routes'
const createServer = process.env.NODE_ENV === 'production' ? httpsCreateServer.createServer : httpCreateServer.createServer;
const app = express();
